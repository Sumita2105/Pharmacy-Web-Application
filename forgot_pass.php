...

{
	...
	$result=mysqli_query($con, "SELECT * from registration where email='". $_POST['email']. "'");
...
{           
           ...
           if(isset($_SESSION['mail']))
		   {
            ...
            $sql = "select * from registration where email='" . $_SESSION['mail']."' ";
            ...
            if($count == 1){  
			     $query2 = "UPDATE registration set password='$h' WHERE email='" . $_SESSION['mail']."' ";
